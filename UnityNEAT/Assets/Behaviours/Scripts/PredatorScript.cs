...
/// movement script for predator behaviours
/// 
...
public class PredatorScript : MonoBehaviour {
	...
	Vector3 getForce(){
		...
		//constantly scanning for enemies, food and objects to avoid
		force += Scan ();

		return force;
	}

	//delete creature if it somehow glitches out of its area
	void checkDist(){
